...
Model Architecture we use in this project

# Model Architecture in Prose
...
```
### Install packages
```{r install-python-pkgs, include=FALSE, eval=FALSE}
library(reticulate)
...
### Load packages(Load Roberta and fine tune)
```{python, eval=FALSE}
import torch
from torch.utils.data import DataLoader
from transformers import AutoTokenizer, AutoModelForSequenceClassification
...
![learning plot](images/learning_plot_loss.png)

![Accurracy over epochs](images/learning_plot_scores.png)
