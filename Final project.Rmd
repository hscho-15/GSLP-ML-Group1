...
### Perspective in Cognitive Science
  It is proved in cognitive science fields that people get their attention on main ideas. Our cognitive system processes and emphasizes data selectively rather than catching full context at once. For example, when we write essays, people usually loads the most information, main idea, into the first sentence or paragraph.
...
use_python(
  "C:/Users/User/AppData/Local/Programs/Python/Python311/python.exe", #use your own path to python
  required = TRUE
)
py_config()
