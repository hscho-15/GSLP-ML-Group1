...
![Structure of MLP](images/MLP.webp)
|  Backpropagation training is a method that uses gradient descent to train multiple-layer perceptrons. It starts with changing the last hidden layers, and proceeds like optimizing the values towards input layers, by using the values used at step before.
